  ...
  <layout>
    <div class="car-details-container">
      ...
      <div class="row">
        ...
        <div
          class="white_card no-border-left col-lg-3 col-md-12 car-info-right"
        >
      ...
      <div class="car-description row">
        ...
        <div class="col-lg-4 col-sm-12 white_card no-border-right">
          <div class="p-2 m-2">
            ...
            <p>
              <strong>{{ $t("profile.name") }}:</strong> {{ car.owner.name }}
            </p>
            <p>
              <strong>{{ $t("profile.surname") }}:</strong>
              {{ car.owner.surname }}
            </p>
            <p>
              <strong>{{ $t("profile.patronymic") }}:</strong>
              {{ car.owner.fatherName }}
            </p>
            <p>
              <strong>{{ $t("profile.age") }}:</strong> {{ car.owner.age }}
            </p>
            <p>
            ...
            <p>
              <strong>{{ $t("profile.additionalInfo") }}:</strong>
              {{ car.owner.additionalInfo }}
            </p>
          </div>
        </div>
        ...
        <div
          class="col-lg-8 col-sm-12 white_card technical-condition no-border-left"
        >
          <div class="p-2 m-2">
