      ...
      metaTags: [
        {
          name: "description",
          content:
            "Зареєструйтеся на WheelDeal, щоб почати продавати або купувати автомобіль",
        },
        {
          name: "og:title",
      ...
      metaTags: [
        {
          name: "description",
          content:
            "Увійдіть у свій акаунт WheelDeal, щоб продовжити пошуки нового авто, чи продаж свого",
        },
        {
          name: "og:title",
      ...
      metaTags: [
        {
          name: "description",
          content:
            "Відкрийте свій особистий кабінет, щоб додати своє авто на продаж, або знайти потрібне",
        },
        {
          property: "og:title",
      ...
      metaTags: [
        {
          name: "description",
          content:
            "На сторінці всіх користувачів Ви можете переглядати користувачів цього сайту, а також їх оголошення або ж переваги в авто",
        },
        {
          property: "og:title",
          content: "Особистий кабінет",
      ...
      metaTags: [
        {
          name: "description",
          content:
            "На сторінці користувача Ви можете переглядати його оголошення або ж переваги в авто",
        },
        {
          property: "og:title",
          content: "Особистий кабінет",
